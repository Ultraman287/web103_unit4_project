...
const EditOrder = () => {
  ...
  useEffect(() => {
    ...
    getNoodles().then(() => {
      noodles.map((noodle) => {
        if (oldOrderItems.noodle.includes(noodle.name)) {
          handleAddItemToOrder("noodle", noodle);
        }
      });
    });
  }, [oldOrderItems]);
  ...
  useEffect(() => {
    ...
    getProteins().then(() => {
      proteins.map((protein) => {
        if (oldOrderItems.protein.includes(protein.name)) {
          handleAddItemToOrder("protein", protein);
        }
      });
    });
  }, [oldOrderItems]);
  ...
  useEffect(() => {
    ...
    getAddons().then(() => {
      addons.map((addon) => {
        if (oldOrderItems.addon.includes(addon.name)) {
          handleAddItemToOrder("addon", addon);
        }
      });
    });
  }, [oldOrderItems]);
  ...
  useEffect(() => {
    ...
    if (impossibleCombinationSelected) {
      ...
      alert("You have selected an impossible combination");
    } else {
      ...
      <div className="section">
        ...
        <div className="options">
          {noodles.map((noodle) => (
            <div
              className={
                oldOrderItems.noodle.includes(noodle.name)
      ...
      <div className="section">
        ...
        <div className="options">
          {proteins.map((protein) => (
            <div
              className={
                oldOrderItems.protein.includes(protein.name)
                  ? "option-item selected"
                  : "option-item"
              }
      ...
      <div className="section">
        ...
        <div className="options">
          {addons.map((addon) => (
            <div
              className={
                oldOrderItems.addon.includes(addon.name)
                  ? "option-item selected"
                  : "option-item"
              }
              id={"addon" + addon.id}
